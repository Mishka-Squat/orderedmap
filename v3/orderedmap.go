...
func MakeOrderedMap[K comparable, V any]() Of[K, V] {
	return Of[K, V]{
...
func NewOrderedMap[K comparable, V any]() *Of[K, V] {
	return &Of[K, V]{
		kv: make(map[K]*Element[K, V]),
		ll: new(list[K, V]),
	}
...
func NewOrderedMapWithCapacity[K comparable, V any](capacity int) *Of[K, V] {
	return &Of[K, V]{
...
func NewOrderedMapWithElements[K comparable, V any](els ...*Element[K, V]) *Of[K, V] {
...
// pointer will be nil.
func (m Of[K, V]) GetElement(key K) *Element[K, V] {
	element, ok := m.kv[key]
	if ok {
		return element
	}
...
func (m Of[K, V]) Front() *Element[K, V] {
	return m.ll.Front()
}

// Back will return the element that is the last (most recent Set element). If
// there are no elements this will return nil.
func (m Of[K, V]) Back() *Element[K, V] {
	return m.ll.Back()
}
